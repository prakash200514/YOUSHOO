      ...
      <div class="footer-grid">
        <div class="footer-col">
          ...
          <p style="font-size:13px; color:#666; line-height:1.6; margin-bottom:16px;">
            Meesho is India's premier online shopping destination offering over 50 lakh+ high quality products at the lowest wholesale prices. Discover fashion, sarees, kurtis, beauty, electronics & daily essentials with 100% Free Delivery.
          </p>
        ...
        <div class="footer-col">
          ...
          <p style="font-size:13px; color:#666; margin-bottom:10px;">
            <i class="fas fa-envelope" style="color:#9f2089; margin-right:6px;"></i> help@meesho.com
          </p>
          ...
          <div style="background:#fdfafc; border:1px solid #f9d5ef; padding:12px; border-radius:8px;">
            ...
            <div style="font-size:11.5px; color:#555;"><strong>Admin:</strong> admin@meesho.com / admin123</div>
            <div style="font-size:11.5px; color:#555;"><strong>Supplier:</strong> supplier@meesho.com / seller123</div>
            <div style="font-size:11.5px; color:#555;"><strong>Customer:</strong> customer@meesho.com / user123</div>
          </div>
        </div>
      </div>

      <div class="footer-bottom">
        <div>&copy; <?php echo date('Y'); ?> Meesho Inc. All rights reserved. Built with PHP, MySQL & modern Web animations.</div>
